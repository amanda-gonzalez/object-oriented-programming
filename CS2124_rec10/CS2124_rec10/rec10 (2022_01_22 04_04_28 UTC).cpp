...
public:
	...
	virtual void displayNumPages() const = 0; //{ cout << numberOfPages << endl; }
private:
...
public:
	TextBook(unsigned numberOfPages, unsigned numOfIndexPages) : Book(numberOfPages), 
		numOfIndexPages(numOfIndexPages){}
